...
object CustomBindingAdapters {
    ...
    fun setFontStyle(view: View, fontType: Int, inputTypeState: InputTypeState) {
        ...
        if (inputTypeState == InputTypeState.EN_BOLD_UPPER) {
    ...
    fun setImage(view: View, inputTypeState: InputTypeState) {
        val mImage: Int = when (inputTypeState) {
            InputTypeState.EN_UPPER, InputTypeState.KR_SHIFT, InputTypeState.SPECIAL_SECOND -> R.drawable.keyic_shift_activated_black
            InputTypeState.EN_LOWER, InputTypeState.KR_NORMAL, InputTypeState.SPECIAL_FIRST -> R.drawable.keyic_shift_deactivated_black
            InputTypeState.EN_BOLD_UPPER -> R.drawable.keyic_shift_hyperactivated_black
